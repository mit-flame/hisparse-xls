module __t__vba_send_0_next(
  ...
  wire [1:0] concat_1075;
  wire [31:0] new_cur_part;
  wire [2:0] concat_1083;
  wire new_vec_sod__1;
  wire new_vec_sod;
  wire [2:0] concat_1091;
  wire new_mtx_sod__1;
  wire [6:0] concat_1103;
  wire [31:0] data;
  wire [31:0] data__1;
  wire [31:0] row_indx;
  ...
  wire [31:0] one_hot_sel_1076;
  wire or_1077;
  wire one_hot_sel_1084;
  wire or_1085;
  wire one_hot_sel_1092;
  wire or_1093;
  wire [1:0] one_hot_sel_1104;
  wire or_1105;
  ...
  assign and_1088 = eq_898 & p0_stage_done;
  assign t__matrix_payload_two_valid_inv = ~__t__matrix_payload_two_valid_reg;
  assign and_1069 = nor_922 & p0_stage_done;
  assign t__num_col_partitions_valid_inv = ~__t__num_col_partitions_valid_reg;
  assign and_1080 = eq_897 & p0_stage_done;
  assign t__vector_payload_two_valid_inv = ~__t__vector_payload_two_valid_reg;
  assign and_1073 = eq_911 & p0_stage_done;
  assign and_1096 = nor_923 & p0_stage_done;
  assign and_1097 = and_924 & p0_stage_done;
  assign and_1098 = nor_925 & p0_stage_done;
  assign and_1099 = and_926 & p0_stage_done;
  assign and_1100 = nor_927 & p0_stage_done;
  assign and_1101 = and_928 & p0_stage_done;
  assign t__matrix_payload_two_valid_load_en = and_1088 | t__matrix_payload_two_valid_inv;
  assign t__num_col_partitions_valid_load_en = and_1069 | t__num_col_partitions_valid_inv;
  assign t__vector_payload_two_valid_load_en = and_1080 | t__vector_payload_two_valid_inv;
  ...
  assign concat_1075 = {and_1069, and_1073};
  assign new_cur_part = 32'h0000_0000;
  assign concat_1083 = {and_1069, and_1080, and_1073};
  assign new_vec_sod__1 = eq_939 | ____state_4;
  assign new_vec_sod = 1'h0;
  assign concat_1091 = {and_1069, and_1088, and_1073};
  assign new_mtx_sod__1 = cmd__1 == unexpand_for_next_value_182_0_case_0 | ____state_5;
  assign concat_1103 = {and_1069, and_1096, and_1097, and_1098, and_1099, and_1100, and_1101};
  ...
  assign or_1164 = ~p0_stage_done | ____state_2__at_most_one_next_value | rst;
  assign or_1166 = ~p0_stage_done | ____state_3__at_most_one_next_value | rst;
  assign or_1168 = ~p0_stage_done | ____state_4__at_most_one_next_value | rst;
  assign or_1170 = ~p0_stage_done | ____state_5__at_most_one_next_value | rst;
  assign or_1172 = ~p0_stage_done | ____state_0__at_most_one_next_value | rst;
  ...
  assign one_hot_sel_1076 = new_cur_part__1 & {32{concat_1075[0]}} | new_cur_part & {32{concat_1075[1]}};
  assign or_1077 = and_1069 | and_1073;
  assign one_hot_sel_1084 = new_vec_sod & concat_1083[0] | new_vec_sod__1 & concat_1083[1] | new_vec_sod & concat_1083[2];
  assign or_1085 = and_1069 | and_1080 | and_1073;
  assign one_hot_sel_1092 = new_vec_sod & concat_1091[0] | new_mtx_sod__1 & concat_1091[1] | new_vec_sod & concat_1091[2];
  assign or_1093 = and_1069 | and_1088 | and_1073;
  assign one_hot_sel_1104 = unexpand_for_next_value_182_0_case_0 & {2{concat_1103[0]}} | unexpand_for_next_value_182_0_case_3_case_0 & {2{concat_1103[1]}} | unexpand_for_next_value_182_0_case_2_case_1 & {2{concat_1103[2]}} | unexpand_for_next_value_182_0_case_1_case_1 & {2{concat_1103[3]}} | unexpand_for_next_value_182_0_case_1_case_1 & {2{concat_1103[4]}} | unexpand_for_next_value_182_0_case_0 & {2{concat_1103[5]}} | unexpand_for_next_value_182_0_case_0 & {2{concat_1103[6]}};
  assign or_1105 = and_1069 | and_1096 | and_1097 | and_1098 | and_1099 | and_1100 | and_1101;
  ...
  always_ff @ (posedge clk) begin
    if (rst) begin
      ...
      ____state_0 <= or_1105 ? one_hot_sel_1104 : ____state_0;
      ____state_2 <= or_1077 ? one_hot_sel_1076 : ____state_2;
      ____state_1 <= and_1069 ? t__num_col_partitions_select : ____state_1;
      ____state_5 <= or_1093 ? one_hot_sel_1092 : ____state_5;
      ____state_4 <= or_1085 ? one_hot_sel_1084 : ____state_4;
  ...
  `ifdef ASSERT_ON
  ____state_2__at_most_one_next_value_assert: assert property (@(posedge clk) disable iff ($sampled(rst !== 1'h0 || $isunknown(or_1164))) or_1164) else $fatal(0, "More than one next_value fired for state element: __state_2");
  ____state_3__at_most_one_next_value_assert: assert property (@(posedge clk) disable iff ($sampled(rst !== 1'h0 || $isunknown(or_1166))) or_1166) else $fatal(0, "More than one next_value fired for state element: __state_3");
  ____state_4__at_most_one_next_value_assert: assert property (@(posedge clk) disable iff ($sampled(rst !== 1'h0 || $isunknown(or_1168))) or_1168) else $fatal(0, "More than one next_value fired for state element: __state_4");
  ____state_5__at_most_one_next_value_assert: assert property (@(posedge clk) disable iff ($sampled(rst !== 1'h0 || $isunknown(or_1170))) or_1170) else $fatal(0, "More than one next_value fired for state element: __state_5");
  ____state_0__at_most_one_next_value_assert: assert property (@(posedge clk) disable iff ($sampled(rst !== 1'h0 || $isunknown(or_1172))) or_1172) else $fatal(0, "More than one next_value fired for state element: __state_0");
  `endif  // ASSERT_ON
endmodule

...
module single_cluster_opt_driver(
    ...
    output wire [31:0] [7:0] final_vec,

    // ML-send inputs/outputs
    output wire [31:0] t__cur_row_partition,
    output wire t__cur_row_partition_vld,
    output wire [31:0] t__num_col_partitions,
    output wire t__num_col_partitions_vld,
    output wire [31:0] t__tot_num_partitions,
    output wire t__tot_num_partitions_vld,
    // output wire t__unified_addr_rdy,

    // input wire [63:0] t__unified_addr,
    // input wire t__unified_addr_vld,
    ...
    // output wire [159:0] t__unified_pld,
    // output wire t__unified_pld_vld,
    // input wire t__unified_pld_rdy,

    // VL inputs/outputs
    // output wire t__hbm_vector_addr_rdy,
    // output wire [63:0] t__hbm_vector_payload,
    // output wire t__hbm_vector_payload_vld,
    output wire [31:0] t__num_matrix_cols,
    output wire t__num_matrix_cols_vld,
    // input wire [31:0] t__hbm_vector_addr,
    // input wire t__hbm_vector_addr_vld,
    // input wire t__hbm_vector_payload_rdy,
    input wire t__num_matrix_cols_rdy,

    // VAU 0 inputs/outputs
    output wire [31:0] vecbuf0_t__num_col_partitions,
    output wire vecbuf0_t__num_col_partitions_vld,
    // output wire vecbuf0_t__unified_addr_rdy,
    // output wire [95:0] vecbuf0_t__streaming_pld,
    // output wire vecbuf0_t__streaming_pld_vld,
    input wire vecbuf0_t__num_col_partitions_rdy,
    // input wire [127:0] vecbuf0_t__unified_addr,
    // input wire vecbuf0_t__unified_addr_vld,
    // input wire vecbuf0_t__streaming_pld_rdy,

    // VAU 1 inputs/outputs
    output wire [31:0] vecbuf1_t__num_col_partitions,
    output wire vecbuf1_t__num_col_partitions_vld,
    // output wire vecbuf1_t__unified_addr_rdy,
    // output wire [95:0] vecbuf1_t__streaming_pld,
    // output wire vecbuf1_t__streaming_pld_vld,
    input wire vecbuf1_t__num_col_partitions_rdy,
    // input wire [127:0] vecbuf1_t__unified_addr,
    // input wire vecbuf1_t__unified_addr_vld,
    // input wire vecbuf1_t__streaming_pld_rdy,

    // PE0_send inputs/outputs
    output wire [29:0] pe0_t__num_rows_updated,
    output wire pe0_t__num_rows_updated_vld,
    input wire pe0_t__num_rows_updated_rdy,
    // PE0_arbiter inputs/outputs
    // output wire pe0_t__unified_addr_rdy,
    // input wire [127:0] pe0_t__unified_addr,
    // input wire pe0_t__unified_addr_vld,
    // PE0_recv inputs/oututs
    output wire [31:0] pe0_t__stream_id,
    output wire pe0_t__stream_id_vld,
    // output wire [127:0] pe0_t__unified_pld,
    // output wire pe0_t__unified_pld_vld,
    // output wire pe0_t__accumulation_addr_rdy,
    // output wire [127:0] pe0_t__dummy_accumulate_pld,
    // output wire pe0_t__dummy_accumulate_pld_vld,
    input wire pe0_t__stream_id_rdy,
    // input wire pe0_t__unified_pld_rdy,
    // input wire [127:0] pe0_t__accumulation_addr,
    // input wire pe0_t__accumulation_addr_vld,

    // PE1_send inputs/outputs
    output wire [29:0] pe1_t__num_rows_updated,
    output wire pe1_t__num_rows_updated_vld,
    input wire pe1_t__num_rows_updated_rdy,
    // PE1_arbiter inputs/outputs
    // output wire pe1_t__unified_addr_rdy,
    // input wire [127:0] pe1_t__unified_addr,
    // input wire pe1_t__unified_addr_vld,
    // PE1_recv inputs/oututs
    output wire [31:0] pe1_t__stream_id,
    output wire pe1_t__stream_id_vld,
    // output wire [127:0] pe1_t__unified_pld,
    // output wire pe1_t__unified_pld_vld,
    // output wire pe1_t__accumulation_addr_rdy,
    // output wire [127:0] pe1_t__dummy_accumulate_pld,
    // output wire pe1_t__dummy_accumulate_pld_vld,
    // input wire pe1_t__stream_id_rdy,
    // input wire pe1_t__unified_pld_rdy,
    // input wire [127:0] pe1_t__accumulation_addr,
    // input wire pe1_t__accumulation_addr_vld,

    // kmerger inputs/outputs
    output wire [31:0] kmerger_t__current_row_partition,
    output wire kmerger_t__current_row_partition_vld,
    output wire kmerger_t__hbm_vector_addr_rdy,
    output wire kmerger_t__hbm_vector_payload_rdy,
    output wire [31:0] kmerger_t__num_hbm_channels_each_kernel,
    output wire kmerger_t__num_hbm_channels_each_kernel_vld,
    ...
    logic [1:0] cur_row_part, cur_res_read; // <-- left off here, cur_res_read is the loop for reading the results
